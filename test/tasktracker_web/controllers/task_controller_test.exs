defmodule TasktrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{assignee: "some assignee", completed: true, desc: "some desc", time: 42, title: "some title"}
  @update_attrs %{assignee: "some updated assignee", completed: false, desc: "some updated desc", time: 43, title: "some updated title"}
  @invalid_attrs %{assignee: nil, completed: nil, desc: nil, time: nil, title: nil}
